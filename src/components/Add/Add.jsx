    ...
    return (
        <div className={style.add_wrapper}>
            ...
            <form onSubmit={(e) => onSubmitHandle(e)}>
                <input type="text" placeholder='Имя' name='first_name' onChange={(e) => onChangeForm(e)}/>
                <input type="text" placeholder='Фамилия' name='last_name' onChange={(e) => onChangeForm(e)}/>
                <textarea name="message" id="" cols="30" rows="10" placeholder='Сообщение' onChange={(e) => onChangeForm(e)}></textarea>
                ...
                <input type="email" name='email' placeholder='email' onChange={(e) => onChangeForm(e)}/>
                <input type="submit" value="ОТПРАВИТЬ" onClick={(e) => onClickHandle(e)}/>
            </form>
        </div>
    )
}
